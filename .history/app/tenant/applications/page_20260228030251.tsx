              ...
              <Card key={viewing.id} className="hover:shadow-md transition-shadow">
                <CardContent className="pt-6">
                  <div className="flex gap-4">
                    ...
                    <div className="h-24 w-24 rounded-lg overflow-hidden shrink-0">
                      <PropertyImage
                        images={viewing.property?.property_images ?? []}
                    ...
                    <div className="flex-1">
                      <div className="flex items-start justify-between gap-2 mb-2 flex-wrap">
                        <div>
                          ...
                          <p className="text-gray-600 flex items-center text-sm mt-0.5">
                            ...
                            {viewing.property?.address ?? "No address"}
                          </p>
                        </div>
                        <Badge
                          className={`shrink-0 ${
                      ...
                      {/* Viewing details */}
                      <div className="flex items-center text-sm text-gray-600 gap-4 mt-3">
                        <div className="flex items-center">
                          <Calendar className="h-4 w-4 mr-2" />
                          {new Date(viewing.requested_date).toLocaleDateString()}
                        </div>
                        <div className="flex items-center">
                      ...
                      {/* Messages */}
                      {viewing.landlord_message && (
                        <div className="mt-3 p-3 bg-blue-50 rounded border border-blue-100">
                          <p className="text-sm text-gray-600">
                            <span className="font-medium">Landlord message:</span> {viewing.landlord_message}
                          </p>
                        </div>
                      )}
                      {viewing.tenant_message && (
                        <div className="mt-3 p-3 bg-gray-50 rounded border border-gray-100">
                          <p className="text-sm text-gray-600">
                            <span className="font-medium">Your message:</span> {viewing.tenant_message}
                          </p>
                        </div>
                      )}
                    </div>
