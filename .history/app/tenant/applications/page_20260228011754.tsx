...
export default function TenantApplicationsPage() {
  ...
  "applications",
  (payload: unknown) => {
    // Type guard to narrow the unknown type
    if (
      payload &&
      ...
      const typedPayload = payload as { tenant_id: string };
      
      if (typedPayload.tenant_id === profile?.id) {
        console.log("📡 Application update received:", typedPayload);
        fetchApplications();
      }
    }
  },
