...
export default function TenantMessagesPage() {
  ...
  const sendReply = async () => {
    ...
    const isLocked = !messageableContacts.has(selectedConversation.landlord.id)
    if (isLocked) {
      alert('Messaging is locked. Please approve your application or sign your lease first.')
      return
    }
